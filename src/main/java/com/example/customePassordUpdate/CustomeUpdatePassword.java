...
//  import org.keycloak.utils.RequiredActionHelper;
  ...
  * @version $Revision: 1 $
  */
 public class CustomeUpdatePassword implements RequiredActionProvider, RequiredActionFactory {
 
     private static final Logger logger = Logger.getLogger(CustomeUpdatePassword.class);
     ...
     /**
      * @deprecated use {@link #CustomeUpdatePassword(KeycloakSession)} instead
      */
     @Deprecated
     public CustomeUpdatePassword() {
         this(null);
     }
 
     public CustomeUpdatePassword(KeycloakSession session) {
     ...
     public RequiredActionProvider create(KeycloakSession session) {
         return new CustomeUpdatePassword(session);
     }
