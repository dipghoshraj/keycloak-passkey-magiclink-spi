...
import static com.example.auth.util.MagicLinkConstants.SESSION_CONFIRMED;
import static com.example.auth.util.MagicLinkConstants.SESSION_EXPIRATION;
import static com.example.auth.util.MagicLinkConstants.SESSION_INITIATED;
import static com.example.auth.util.MagicLinkConstants.TIMEOUT;
import static org.keycloak.services.validation.Validation.FIELD_USERNAME;

import com.example.MagicLink;
import com.example.auth.token.MagicLinkContinuationActionToken;
