 ...
 * @version $Revision: 1 $
 */
public class CustomeResetCredentialEmail implements Authenticator, AuthenticatorFactory {

    private static final Logger logger = Logger.getLogger(CustomeResetCredentialEmail.class);
